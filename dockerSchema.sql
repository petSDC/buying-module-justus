...
copy products (product_name, free_shipping, option_name, different_options, price, quantity, handmade, made_to_order, materials, gift_message, gift_card, shipping_min_days, shipping_max_days, shipping_price) from '/Users/justuskovats-wildenradt/hack-reactor/sdc/buying-module-justus/DOC_countries_shipping.txt' (delimiter(','));
